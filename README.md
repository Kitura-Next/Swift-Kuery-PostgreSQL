...
<p align="center">
    <a href="https://kitura-next.github.io/Swift-Kuery-PostgreSQL/index.html">
    <img src="https://img.shields.io/badge/apidoc-SwiftKueryPostgreSQL-1FBCE4.svg?style=flat" alt="APIDoc">
    </a>
    <a href="https://travis-ci.org/Kitura-Next/Swift-Kuery-PostgreSQL">
    <img src="https://travis-ci.org/Kitura-Next/Swift-Kuery-PostgreSQL.svg?branch=master" alt="Build Status - Master">
    </a>
...
[PostgreSQL](https://www.postgresql.org/) plugin for the [Swift-Kuery](https://github.com/Kitura-Next/Swift-Kuery) framework. It enables you to use Swift-Kuery to manipulate data in a PostgreSQL database.
...
Add the `SwiftKueryPostgreSQL` package to the dependencies within your application’s `Package.swift` file. Substitute `"x.x.x"` with the latest `SwiftKueryPostgreSQL` [release](https://github.com/Kitura-Next/Swift-Kuery-PostgreSQL/releases).
...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/Kitura-Next/Kitura.git", from: "x.x.x"),
        .package(url: "https://github.com/Kitura-Next/Swift-Kuery-PostgreSQL", from: "x.x.x")
    ],
    targets: [
        .target(
            name: "swift-kuery-play",
...
```
## API Documentation
For more information visit our [API reference](https://kitura-next.github.io/Swift-Kuery-PostgreSQL/index.html).
...
## License
This library is licensed under Apache 2.0. Full license text is available in [LICENSE](https://github.com/Kitura-Next/SwiftKueryPostgreSQL/blob/master/LICENSE.txt)
